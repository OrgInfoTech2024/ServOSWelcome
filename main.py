...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.seventhPageLabel = QLabel(self.lang[self.syslang]["Finish"], self)
        self.seventhPageLabel.setGeometry(5, 155, 140, 20)
        ...
        self.timeZoneComboBox.setGeometry(150, 100, 150, 30)
        ...
        self.timeZoneLabel.setGeometry(150, 50, 300, 50)
        self.timeZoneLabel.hide()
        
        self.sixthBackButton = QPushButton(self.lang[self.syslang]["Back"], self)
        self.sixthBackButton.setGeometry(150, 260, 60, 30)
    ...
    def Resize(self, event):
        ...
        self.secondBackButton.setGeometry(150, rightForButton, 60, 30)
        self.secondNextButton.setGeometry(leftForButton, rightForButton, 60, 30)
        self.thirdBackButton.setGeometry(150, rightForButton, 60, 30)
        self.thirdNextButton.setGeometry(leftForButton, rightForButton, 60, 30)
        self.fourthBackButton.setGeometry(150, rightForButton, 60, 30)
        self.fourthNextButton.setGeometry(leftForButton, rightForButton, 60, 30)
        self.fifthBackButton.setGeometry(150, rightForButton, 60, 30)
        self.fifthNextButton.setGeometry(leftForButton, rightForButton, 60, 30)
        self.sixthBackButton.setGeometry(150, rightForButton, 60, 30)
        ...
        self.community_input.setGeometry(150, 100, self.width() - 285, 30)
        self.add_button.setGeometry(self.width() - 135, 100, 50, 30)
        self.remove_button.setGeometry(self.width() - 85, 100, 75, 30)
        self.weather_listbox.setGeometry(150, 130, self.width() - 160, self.height() - 175)
